...
|---|---|
| 设计报告 `DESIGN.md` | ✅ 完成 |
| 实施路线 `ROADMAP.md` | ✅ 完成(本文) |
| ADR 模板 | ✅ 完成 |
| **阶段 0 · 纸上作业** | 📋 **提示词已就绪,等你填** → [`stages/stage-00.md`](stages/stage-00.md) |
| 阶段 1–10 | ⏸ 未开始 |

**下一步**:填完 `stages/stage-00.md` 的 T0.1–T0.5,然后 Claude 出 `stage-01.md` + `rung-core` 骨架。

在 T0.5 写下三个第一反应之前,不要开始阶段 1 —— 那五行字是整个项目唯一一次能记录
「你还不知道答案时是怎么想的」的机会,过了阶段 3 就再也写不出来了。
