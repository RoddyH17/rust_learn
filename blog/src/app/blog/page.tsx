...
export const metadata: Metadata = {
  title: "Blog",
  description: "Daily Rust learning notes, from a C++ perspective.",
  openGraph: {
    title: "Blog",
    description: "Daily Rust learning notes, from a C++ perspective.",
  },
    ...
    <section id="blog">
      <BlurFade delay={BLUR_FADE_DELAY}>
        ...
        <p className="text-sm text-muted-foreground mb-8">
          One post a day: what I learned in Rust, and how it compares to C++.
        </p>
      </BlurFade>
        ...
        <BlurFade delay={BLUR_FADE_DELAY * 2}>
          <div className="flex flex-col gap-5">
            {sortedPosts.map((post, id) => {
              ...
              const indexNumber = sortedPosts.length - id;
              return (
